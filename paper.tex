...
\begin{compactitem}
    ...
    \item ``[S]imilarity\ldots is a relationship between two objects \emph{under a given description}'' \cite{WCS:WCS1282}. Global similarity judgement omit the description and possibly give imprecise global similarity. Is \textit{apple}'s similarity to \textit{orange} as a company the same as a fruit?
